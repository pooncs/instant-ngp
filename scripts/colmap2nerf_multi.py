...
if __name__ == "__main__":
	...
	args.aabb_scale = 1
	args.images = "/home/ubuntu/ws/data/nerf/shuttleTest8/dense/1/images"
	args.text = "/home/ubuntu/ws/data/nerf/shuttleTest8/dense/1/sparse" 
	args.out = "/home/ubuntu/ws/data/nerf/shuttleTest8/transforms_col.json"
	...
	with open(os.path.join(TEXT_FOLDER,"cameras.txt"), "r") as f:
		...
		for line in f:
			...
			cx = w / 2
			cy = h / 2
			cams[els[0]] = [angle_x, angle_y, fl_x, fl_y, k1, k2, p1, p2, cx, cy, w, h]
		...
		for line in f:
			...
			if  i % 2 == 1:
				...
				if not args.keep_colmap_coords:
					...
					up += c2w[0:3,1]
				frame={	
					"camera_angle_x": cams[elems[8]][0],
					"camera_angle_y": cams[elems[8]][1],
					"fl_x": cams[elems[8]][2],
					"fl_y": cams[elems[8]][3],
					"k1": cams[elems[8]][4],
					"k2": cams[elems[8]][5],
